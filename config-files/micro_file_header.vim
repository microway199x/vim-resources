...
function AddVerilogTpl()
    :0read  $VIM/micro_plugin/file_tpl/verilog.tpl
    call UpdateTitle()
endfunction
...
autocmd BufNewFile *.lua  :0r $VIM/micro_plugin/file_tpl/lua.tpl
autocmd BufNewFile *.py  :0r $VIM/micro_plugin/file_tpl/python.tpl
